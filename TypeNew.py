...
if tests:    
    ...
    chunk = tc0a.chunk_at_depth(tc0a,depth=0)
    print(chunk)
    chunk = chunk.chunk_at_depth(tc1a,depth=1)
    print(chunk)
    chunk = chunk.chunk_at_depth(tc2a,depth=1)
    print(chunk)
    chunk = chunk.chunk_at_depth(tc3a,depth=1)
    print(chunk)
    #chunk = chunk.chunk_at_depth(tc4a,depth=2)
    #print(chunk)
    
    print(chunk.reduce())
    new_tchunk = chunk.retype_root(t6,[1,1,2,2])
    print(new_tchunk)
    print(new_tchunk.reduce())
    new_tchunk = new_tchunk.retype_root(t6,[1,1,2,2])
    print(new_tchunk)
    print(new_tchunk.reduce())
    #print(new_tchunk)
    #print(types[0].split())
