...
n_subjects=4
n_objects=4
n_transitive_verbs=2
n_intransitive_verbs=32
...
def fig_learning():
    ...
    plt.plot(reinforcements, 'k',linestyle='-', color = 'green', label = 'No Types')
    title = 'Language: '+str(n_subjects) + ' nouns ' + str(n_intransitive_verbs) + ' intransitive verbs ' #+ str(n_transitive_verbs) + ' transitive verbs '
    #if not zipf_distribution:
        #title += ' no Zipf'
    plt.title(title)
    plt.xlabel('Trial')
    plt.ylabel('Frequency of correct responses')
    plt.legend(title='Learner',loc = 'best')
